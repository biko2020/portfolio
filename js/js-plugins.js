...
!(function (t, e) {
  ...
  function o(e, n) {
    n || (t.cssNumber[e] = !0),
      (t.transit.propertyMap[e] = d.transform),
      (t.cssHooks[e] = {
        get: function (n) {
  ...
  (d.transition = e("transition")),
    (d.transitionDelay = e("transitionDelay")),
    (d.transform = e("transform")),
    (d.transformOrigin = e("transformOrigin")),
    (d.filter = e("Filter")),
    (d.transform3d = n());
  var h = {
      ...
      setter: {
        ...
        translate: function (t, e) {
          void 0 === this._translateX && (this._translateX = 0),
            ...
            null !== t && void 0 !== t && (this._translateX = c(t, "px")),
            null !== e && void 0 !== e && (this._translateY = c(e, "px")),
      ...
      function (e, n, i, s) {
        ...
        "function" == typeof n && ((s = n), (n = void 0)),
          "object" == typeof n &&
            ((i = n.easing),
            (u = n.delay || 0),
            (c = "undefined" == typeof n.queue ? !0 : n.queue),
            (s = n.complete),
            (n = n.duration)),
          "function" == typeof i && ((s = i), (i = void 0)),
          "undefined" != typeof p.easing && ((i = p.easing), delete p.easing),
          "undefined" != typeof p.duration &&
            ((n = p.duration), delete p.duration),
          "undefined" != typeof p.complete &&
            ((s = p.complete), delete p.complete),
          "undefined" != typeof p.queue && ((c = p.queue), delete p.queue),
          "undefined" != typeof p.delay && ((u = p.delay), delete p.delay),
          "undefined" == typeof n && (n = t.fx.speeds._default),
          "undefined" == typeof i && (i = t.cssEase._default),
          (n = f(n));
        var l = a(p, n, i, u),
        ...
        var m = {},
          v = function (e) {
            ...
            y > 0 && b && t.transit.useTransitionEnd
              ? ((n = !0), o.bind(b, i))
              : window.setTimeout(i, y),
              o.each(function () {
  ...
  var Instagram = {
    ...
    getRecentMedia: function (userID) {
      var self = this,
        getData =
          ...
          userID +
          "/media/recent/?" +
          self.accessData.clientID +
          "&access_token=" +
          self.accessData.accessToken +
          "";
    ...
    display: function (results) {
      var self = this,
        ...
        size,
        max =
          self.options.max >= results.data.length
            ? results.data.length
            : self.options.max;
      if (results.data.length === 0) {
        self.$elem.append(
          $(self.options.wrapEachWith).append(self.options.notFoundMsg)
        );
      } else {
        for (var i = 0; i < max; i++) {
          if (setSize == "small") {
...
(function (e) {
  e.easyPieChart = function (t, n) {
    ...
    r = function (e) {
      var t;
      t = e % 6 === 0 ? 0 : c.options.size * 0.017;
      c.ctx.save();
      c.ctx.rotate((e * Math.PI) / 12);
      c.ctx.fillRect(c.options.size / 2 - t, 0, -c.options.size * 0.05 + t, 1);
      c.ctx.restore();
    };
    l = function () {
      var e;
    ...
    s = function (t) {
      var n;
      a();
      c.ctx.strokeStyle = e.isFunction(c.options.barColor)
        ? c.options.barColor(t)
        : c.options.barColor;
      c.ctx.lineCap = c.options.lineCap;
      c.ctx.lineWidth = c.options.lineWidth;
      n = c.options.size / 2 - c.options.lineWidth / 2;
      if (c.options.scaleColor !== false) {
        n -= c.options.size * 0.08;
      }
      c.ctx.save();
  ...
  var a = "animsition",
    i = {
      init: function (t) {
        ...
        return (
          e && i.addOverlay.call(this, t),
          t.loading && i.addLoading.call(this, t),
          this.each(function () {
            var o = this,
              e = n(this),
              s = n(window),
      ...
      addOverlay: function (a) {
        n(a.overlayParentElement).prepend(
          '<div class="' + a.overlayClass + '"></div>'
        );
      },
      addLoading: function (a) {
        n(a.loadingParentElement).append(
          '<div class="' + a.loadingClass + '">' + a.loadingHtml + "</div>"
        );
      },
      ...
      pageIn: function () {
        ...
        e.loading && i.removeLoading.call(t),
          d ? i.pageInOverlay.call(t, c, r) : i.pageInBasic.call(t, c, r);
      },
      pageInBasic: function (a, i) {
        var t = n(this);
        t.css({ "animation-duration": i / 1e3 + "s" })
          .addClass(a)
      ...
      pageOutBasic: function (a, i, t) {
        var o = n(this);
        o.css({ "animation-duration": i / 1e3 + "s" })
          .addClass(a)
          .animateCallback(function () {
            location.href = t;
          });
  ...
  (n.fn.animateCallback = function (a) {
    ...
    (n.fn.animsition = function (t) {
      return i[t]
        ...
        : "object" != typeof t && t
        ? void n.error("Method " + t + " does not exist on jQuery." + a)
...
(mejs.version = "2.18.1"),
  ...
  (mejs.MediaFeatures = {
    init: function () {
      ...
      (c.hasSemiNativeFullScreen =
        "undefined" != typeof b.webkitEnterFullscreen),
        ...
        c.hasSemiNativeFullScreen &&
          ...
          ((c.hasNativeFullScreen = !1), (c.hasSemiNativeFullScreen = !1));
    },
  }),
      ...
      (mejs.MediaElementPlayer.prototype = {
        ...
        init: function () {
          ...
          if (
            ...
            b.options[h + "Width"] > 0 ||
            b.options[h + "Width"].toString().indexOf("%") > -1
              ? (b.width = b.options[h + "Width"])
              ...
              : (b.width = b.options["default" + i + "Width"]),
              b.options[h + "Height"] > 0 ||
              b.options[h + "Height"].toString().indexOf("%") > -1
                ? (b.height = b.options[h + "Height"])
                ...
                : (b.height = b.options["default" + i + "Height"]),
    ...
    a.extend(mejs.MepDefaults, {
      ...
      a.extend(MediaElementPlayer.prototype, {
        ...
        updateCurrent: function () {
          ...
          a.currenttime &&
            a.currenttime.html(
              mejs.Utility.secondsToTimeCode(a.media.currentTime, a.options)
            );
        },
        updateDuration: function () {
          ...
          a.container.toggleClass("mejs-long-video", a.media.duration > 3600),
            a.durationD &&
              (a.options.duration > 0 || a.media.duration) &&
              a.durationD.html(
                mejs.Utility.secondsToTimeCode(
      ...
      a.extend(MediaElementPlayer.prototype, {
            ...
            var g = this,
              h = a(
                '<div class="mejs-button mejs-fullscreen-button"><button type="button" aria-controls="' +
                  g.id +
                  '" title="' +
                  g.options.fullscreenText +
                  '" aria-label="' +
                  g.options.fullscreenText +
                  '"></button></div>'
              ).appendTo(c);
            if (
              "native" === g.media.pluginType ||
              (!g.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox)
            )
              h.click(function () {
                var a =
                  (mejs.MediaFeatures.hasTrueNativeFullScreen &&
              ...
              if (j && !mejs.MediaFeatures.isOpera) {
                var k,
                  ...
                  n = function () {
                    if (m) {
                      ...
                      h.css("pointer-events", ""),
                        ...
                        g.media.removeEventListener(
                          "click",
                          g.clickToPlayPauseCallback
                        ),
                        (m = !1);
                    }
                  },
                  ...
                  q = function () {
                    ...
                    for (k in o)
                      o[k].css({ position: "absolute", top: 0, left: 0 });
                ...
                for (
                  ...
                  o[p[k]] = a('<div class="mejs-fullscreen-hover" />')
                ...
                h.on("mouseover", function () {
                  ...
                  g.globalBind("mousemove", function (a) {
                    if (m) {
                      var b = h.offset();
                      (a.pageY < b.top ||
                        a.pageY > b.top + h.outerHeight(!0) ||
                        a.pageX < b.left ||
                        a.pageX > b.left + h.outerWidth(!0)) &&
                        (h.css("pointer-events", ""),
                        g.controls.css("pointer-events", ""),
                        (m = !1));
                    }
        ...
        enterFullScreen: function () {
          ...
          if (
            ...
            (!mejs.MediaFeatures.isFirefox && !b.options.usePluginFullScreen)
          ) {
            if (
        ...
        exitFullScreen: function () {
          ...
          return (
            ...
            "native" !== b.media.pluginType && mejs.MediaFeatures.isFirefox
              ? void b.media.setFullscreen(!1)
              : (mejs.MediaFeatures.hasTrueNativeFullScreen &&
...
!(function (e) {
  ...
  e.fn.interactive_bg = function (n) {
    return this.each(function () {
      ...
      i.find("> .ibg-bg").css({ width: o, height: s });
      if (f || screen.width <= 699) {
        ...
        function l(e) {
          ...
          i.find("> .ibg-bg").css({
            "-webkit-transform":
              "matrix(" + r.scale + ",0,0," + r.scale + "," + u + "," + a + ")",
            "-moz-transform":
              "matrix(" + r.scale + ",0,0," + r.scale + "," + u + "," + a + ")",
            "-o-transform":
              "matrix(" + r.scale + ",0,0," + r.scale + "," + u + "," + a + ")",
        ...
        i.mouseenter(function (e) {
          ...
          i.find("> .ibg-bg")
            .css({
              "-webkit-transform":
                "matrix(" + r.scale + ",0,0," + r.scale + ",0,0)",
              "-moz-transform":
                "matrix(" + r.scale + ",0,0," + r.scale + ",0,0)",
              "-o-transform": "matrix(" + r.scale + ",0,0," + r.scale + ",0,0)",
              transform: "matrix(" + r.scale + ",0,0," + r.scale + ",0,0)",
              "-webkit-transition":
                "-webkit-transform " + r.animationSpeed + " linear",
              "-moz-transition":
                "-moz-transform " + r.animationSpeed + " linear",
